...
class Blockchain {
    ...
    constructor() {
        this.chain = [];
        this.height = -1;
        this.initializeChain().then(r => console.log(`init chain result ${r}`));
    }
    ...
    _addBlock(block) {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                self.height += 1;
                resolve(block); // resolve with the block
            } catch (e) {
                reject(e);
            }
        });
    ...
    requestMessageOwnershipVerification(address) {
        return new Promise((resolve, reject) => {
            ...
            // the time in this message will allow you to validate the 5 minutes time window.
        });
    }
    ...
    getBlockByHash(hash) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (targetBlock === undefined) {
                reject(`Block with hash ${hash} is not found.`)
            } else {
                resolve(targetBlock)
            }
        });
    ...
    getStarsByWalletAddress(address) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (stars.length > 0) {
                ...
                reject(`No starts found with address ${address}`);
            }
        });
    }
